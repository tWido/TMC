#############################################################################
# Makefile for building: bc-thorlabs
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  bc-thorlabs.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile bc-thorlabs.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES) -std=c++11  
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I../why_me -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread -lftd2xx 
AR            = ar cqs
RANLIB        = 
...
Makefile: bc-thorlabs.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile bc-thorlabs.pro
...
dist: 
	@test -d .tmp/bc-thorlabs1.0.0 || mkdir -p .tmp/bc-thorlabs1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bc-thorlabs1.0.0/ && $(COPY_FILE) --parents ftdi_lib/ftd2xx.h ftdi_lib/WinTypes.h src/api.hpp src/api_calls.hpp src/cmd.hpp src/device.hpp src/gui.hpp src/init.hpp src/message_codes.hpp .tmp/bc-thorlabs1.0.0/ && $(COPY_FILE) --parents src/gui.cpp src/main.cpp .tmp/bc-thorlabs1.0.0/ && (cd `dirname .tmp/bc-thorlabs1.0.0` && $(TAR) bc-thorlabs1.0.0.tar bc-thorlabs1.0.0 && $(COMPRESS) bc-thorlabs1.0.0.tar) && $(MOVE) `dirname .tmp/bc-thorlabs1.0.0`/bc-thorlabs1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bc-thorlabs1.0.0
...
moc_gui.cpp: /usr/include/qt5/QtCore/QVariant \
...
main.o: src/main.cpp src/api_calls.hpp \
		src/api.hpp \
		ftdi_lib/ftd2xx.h \
		ftdi_lib/WinTypes.h \
		src/device.hpp \
